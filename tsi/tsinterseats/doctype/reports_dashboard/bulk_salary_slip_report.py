...
@frappe.whitelist()
def enqueue_download_multi_pdf(start_date,end_date,employee_catagory=None):
	conditions = ''
	if employee_catagory:
		conditions += 'and category="%s"' % employee_catagory
	...
	enqueue(download_multi_pdf, queue='default', timeout=8000, event='download_multi_pdf',doctype="Salary Slip", name=json.dumps(salary_slips), format='Salary Slip')
